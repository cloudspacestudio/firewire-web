...
const firewire_about_data_1 = require("./data/firewire.about.data");
...
class FirewireManifest extends base_manifest_1.BaseManifest {
    constructor() {
        ...
        this.dependencies = [];
        this.items = [];
        this.items.push(...firewire_about_data_1.FirewireAboutData.manifestItems);
        ...
        this.items.push(...firewire_about_data_1.FirewireAboutData.legacyFieldwireAliasItems);
