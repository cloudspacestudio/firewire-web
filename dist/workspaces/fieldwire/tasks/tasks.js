            ...
            fx: (req, res) => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const result = yield fieldwire.projectTasks(projectId);
                        res.status(200).json({
                            rows: result
                        });
                        return resolve(true);
            ...
            fx: (req, res) => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const result = yield fieldwire.projectTaskTypeAttributes(projectId);
                        res.status(200).json({
                            rows: result
                        });
                        return resolve(true);
            ...
            fx: (req, res) => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const result = yield fieldwire.seedFromTestDevices(req.app);
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if (req.body.task_type_id)
                            task.task_type_id = req.body.task_type_id;
                        if (req.body.location_id)
                            task.location_id = req.body.location_id;
                        if (req.body.due_date)
                            task.due_date = req.body.due_date;
                        if (req.body.cost_value)
                            task.cost_value = req.body.cost_value;
                        if (req.body.man_power_value)
                            task.man_power_value = req.body.man_power_value;
                        if (req.body.due_at)
                            task.due_at = req.body.due_at;
                        if (req.body.end_at)
                            task.end_at = req.body.end_at;
                        if (req.body.start_at)
                            task.start_at = req.body.start_at;
                        if (req.body.fixed_at)
                            task.fixed_at = req.body.fixed_at;
                        if (req.body.verified_at)
                            task.verified_at = req.body.verified_at;
                        const result = yield fieldwire.createTask(task);
                        res.status(200).json({
                            result
                        });
                        return resolve(true);
            ...
            fx: (req, res) => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const result = yield fieldwire.deleteAllTasks(projectId, false);
                        res.status(200).json(result);
                        return resolve(true);
                    }
                    catch (err) {
            ...
            fx: (req, res) => {
                ...
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const result = yield fieldwire.taskEmail(params);
                        res.status(201).json({
                            message: result
                        });
                        return resolve(true);
